...
version = "0.1"
group = "dev.aleixmorgadas.reactivemicroservicesworkshop"
...
micronaut {
    ...
    processing {
        incremental(true)
        annotations("dev.aleixmorgadas.reactivemicroservicesworkshop.*")
    }
}
...
application {
    mainClass.set("dev.aleixmorgadas.reactivemicroservicesworkshop.ApplicationKt")
}
java {
